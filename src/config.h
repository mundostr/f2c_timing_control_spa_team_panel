...
https://drive.google.com/drive/folders/1-U5LojzlbU2sCFoRP0HKdWDOntVJDE-I

Distribución de dígitos: 6+12+12+12+8+12+12+12+12+12+12+6
*/
...
int laps_limit = 100; // Límite para detención de crono / Limit to stop timing
int laps_counter = 0; // Contador de vueltas de carrera / Race laps counter
int faults_counter = 0; // Contador de infracciones / Warnings counter
